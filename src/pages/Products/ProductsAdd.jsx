                                ...
                                <div className="d-flex justify-content-start align-items-center gap-2">
                                  ...
                                  <label>
                                    <Field
                                      ...
                                      value="XXL"
                                      onClick={() => {
                                        if (!checkSizesArray.includes("XXL")) {
                                          setCheckSizesArray([
                                            ...checkSizesArray,
                                            "XXL",
                                          ]);
                              ...
                              >
                                ...
                                <label>
                                  <Field
                                    ...
                                    value="green"
                                    onClick={() => {
                                      if (!checkColorsArray.includes("green")) {
                                        setCheckColorsArray([
                                          ...checkColorsArray,
                                          "green",
                                        ]);
                                ...
                                <label>
                                  <Field
                                    ...
                                    value="black"
                                    onClick={() => {
                                      if (!checkColorsArray.includes("black")) {
                                        setCheckColorsArray([
                                          ...checkColorsArray,
                                          "black",
                                        ]);
                                ...
                                <label>
                                  <Field
                                    ...
                                    value="gray"
                                    onClick={() => {
                                      if (!checkColorsArray.includes("gray")) {
                                        setCheckColorsArray([
                                          ...checkColorsArray,
                                          "gray",
                                        ]);
                      ...
                      <div className="row mb-3">
                        <div className="form-outline col-lg-6 mb-0">
                          <Form.Group className="form-outline mb-0">
                            ...
                            <InputGroup hasValidation className="text-dark">
                              <JoditEditor
                                name="details"
                                id="details"
                                ref={editor}
