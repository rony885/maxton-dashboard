          ...
          <div className="layout">
            <div className="product_wrapper">
              <div className="categoryProd">
                <div className="mb-4">
                  ...
                  <div className="row d-flex justify-content-between align-items-center">
                    <div className="col-lg-12">
                      <CategoryDataTable data={sampleData} />
                    </div>
                  </div>
                </div>
                ...
                {/* {isModalOpen && (
                  <div className="custom-modal">
                    <div className="modal-content">
                      ...
                      <h2 className="text-dark">Add Category</h2>
                ...
                {/* ===== Custom Modal ===== */}
                <div className="modal fade" id="add_category_modal">
                ...
                {/* ===== Edit Modal ===== */}
                <div className="modal fade" id="edit_category_modal">
                  <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                      <div className="modal-header border-bottom-0 py-2 bg-grd-info">
                        <h5 className="modal-title">Add Category</h5>
                ...
                {/* ===== Delete Modal ===== */}
                <div className="modal fade" id="delete_category_modal">
                  <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
